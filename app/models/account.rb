...
class Account < ActiveRecord::Base
  ...
  attr_protected :bank_account, :referer, :landing_page

  belongs_to :owner, :class_name => 'User'

  # The address is the one in fiscal_data, there was a time where we wanted to
  # have the separate, but after that we simplified this assumption and the
  # fiscal data for *our* invoices to the user is assumed to be the same fiscal
  # date he uses in the application
  #
